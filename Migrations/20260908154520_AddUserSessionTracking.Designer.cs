...
namespace CpPrinting.Api.Migrations
{
    ...
    [Migration("20260908154520_AddUserSessionTracking")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CpPrinting.Api.Models.Customer", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("CpPrinting.Api.Models.InvoiceSecuritySetting", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(450)")
                    ...
                    b.ToTable("InvoiceSecuritySettings");
                });
            ...
            modelBuilder.Entity("CpPrinting.Api.Models.ReconciliationReportRecord", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.Property<int>("FdTotal")
                        .HasColumnType("int");

                    b.Property<int>("GoodQtyTotal")
                        .HasColumnType("int");
                    ...
                    b.Property<string>("JobNos")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<int>("PdTotal")
                        .HasColumnType("int");
                    ...
                    b.Property<int>("RtnTotal")
                        .HasColumnType("int");

                    b.Property<int>("SampleTestingTotal")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CpPrinting.Api.Models.TaxInvoice", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.Property<string>("PurchaserTelephone")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("TotalAmountIncludingVat")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("TotalAmountIncludingVatLkr")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("TotalValueOfSupply")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("TotalValueOfSupplyLkr")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("VatAmountLkr")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.HasIndex("PurchaserTin");

                    b.HasIndex("SupplierTin");

                    b.ToTable("TaxInvoices");
                });

            modelBuilder.Entity("CpPrinting.Api.Models.TaxInvoiceItem", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");

                    b.Property<string>("AmountExcludingVat")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("CpPrinting.Api.Models.UserSession", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.Property<int>("TotalLoginSeconds")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CpPrinting.Api.Models.UserSessionEvent", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("CpPrinting.Api.Models.TaxInvoiceItem", b =>
                {
                    b.HasOne("CpPrinting.Api.Models.TaxInvoice", "TaxInvoice")
                        .WithMany("Items")
